    ...
    sections: [
      {
        ...
        blurb: "Patient findings compared against the literature using subsections (Causes, Clinical Features, Treatment, Complications) and comparison tables.",
        fields: [
          {
            id: "introDefinition",
            label: "Definition of medical tests/investigations (with citation)",
            hint: "Opening definition with in-text citation from reference material.",
            placeholder: "e.g. A medical test is a procedure performed to detect, diagnose, or monitor diseases... (Bolboacă, 2019)",
            type: "textarea",
            span: 2,
          },
          {
            id: "investigationsList",
            label: "List of diagnostic investigations carried out on patient",
            hint: "List each investigation performed on the patient during admission.",
            placeholder: "e.g. Chest x-ray, FBC, Urinalysis, ESR, Sickling test",
            type: "textarea",
            span: 2,
          },
          {
            id: "testsComparisonComment",
            label: "Commentary on % of tests compared to literature",
            hint: "State how many of the patient's tests match the literature standards.",
            placeholder: "e.g. About 67% of diagnostic tests carried out on patient were found in the literature; malaria parasites was not in literature but was requested.",
            type: "textarea",
            span: 2,
          },
          {
            id: "causesComparison",
            label: "Causes: literature vs patient's contributing factors",
            hint: "Compare literature causes with the specific factors contributing to THIS patient's condition.",
            placeholder: "e.g. Literature: bacterial, viral, aspiration. Patient: poor ventilation, dust exposure, weakened immunity.",
            type: "textarea",
            span: 2,
          },
          {
            id: "clinicalFeaturesComparison",
            label: "Clinical features: patient vs literature (for table)",
            hint: "List each clinical feature from literature and state whether the patient exhibited it.",
            placeholder: "e.g. Fever: Present; Cough: Present; Chest pain: Absent; Dyspnea: Present",
            type: "textarea",
            span: 2,
          },
          {
            id: "clinicalFeaturesComment",
            label: "Commentary on % of clinical features exhibited",
            hint: "State the percentage or proportion of clinical features the patient showed.",
            placeholder: "e.g. Patient exhibited about 57% of the signs and symptoms found in literature.",
            type: "textarea",
            span: 2,
          },
          {
            id: "treatmentGivenList",
            label: "List of treatment/medications given to patient",
            hint: "List each drug or treatment the patient received.",
            placeholder: "e.g. IV Ceftriaxone 2g daily, IV Paracetamol 1g tds, Tab Azithromycin 500mg od",
            type: "textarea",
            span: 2,
          },
          {
            id: "treatmentComparison",
            label: "Treatment: patient vs standard (for table and comments)",
            hint: "Compare each treatment given with standard treatment from literature.",
            placeholder: "e.g. Ceftriaxone 2g IV daily: Matches standard first-line therapy; Paracetamol: Given as needed for fever",
            type: "textarea",
            span: 2,
          },
          {
            id: "treatmentComment",
            label: "Commentary on % of drugs from literature given",
            hint: "State what proportion of standard treatment the patient received.",
            placeholder: "e.g. About 75% of drugs found in literature were given to the patient.",
            type: "textarea",
            span: 2,
          },
          {
            id: "complicationsComparison",
            label: "Complications: literature vs patient status",
            hint: "List possible complications from literature and state whether the patient developed any.",
            placeholder: "e.g. Literature: pleural effusion, septicaemia, respiratory failure. Patient: No complications observed.",
            type: "textarea",
            span: 2,
          },
        ],
